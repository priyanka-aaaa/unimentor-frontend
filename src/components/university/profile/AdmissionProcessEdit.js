...
const AdmissionProcessEdit = (props) => {
    ...
    useEffect(() => {
        ...
        // axios.get('/university/61dab27e05671a193cca5f81/admissions/' + value,

        console.log("uhhhhhhhhhhrl1");
        console.log(url1);
        ...
        fetch(url1, {
            ...
            .then(data => {
                ...
                console.log("data.universityAdmissions.point")
                console.log(data.universityAdmission.point)
