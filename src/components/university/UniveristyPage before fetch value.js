                                                    ...
                                                    <div className="card">
                                                        ...
                                                        <div id="collapseOne" className="collapse" data-parent="#accordion">
                                                            <div className="card-body">
                                                                It's not difficult to be accepted into RMIT as an international student.
                                                                You need to provide all the required documents and let them assess your
                                                                application to check if you’re eligible to attend the university.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card">
                                                        <a className="card-header  card-link" data-toggle="collapse" href="#collapseTwo">
                                                            What is flexible study?
                                                        </a>
                                                        <div id="collapseTwo" className="collapse" data-parent="#accordion">
                                                            <div className="card-body">
                                                                Flexible study allows students to study online by participating in
                                                                lectures and tutorials via Canvas, our online learning and teaching
                                                                platform, to ensure continued learning throughout this period. The
                                                                majority of classes and assessments have been rearranged to suit this
                                                                learning format.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card">
                                                        <a className="card-header card-link" data-toggle="collapse" href="#collapseThree">
                                                            Can I complete my entire program online?
                                                        </a>
                                                        <div id="collapseThree" className="collapse" data-parent="#accordion">
                                                            <div className="card-body">
                                                                Students may complete their entire program online if their program is
                                                                completed before border restrictions are eased and on-campus studies
                                                                resume.
                                                            </div>
                                                        </div>
                                                    </div>
