              ...
              <div className="row">
                  ...
                  <div className="services-item pink-light-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/5.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/5.png" alt="" />
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 mb-30">
                  <div className="services-item blue2-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/6.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/6.png" alt="" />
                      </div>
                    </div>
                    <div className="services-content">
                      <div className="services-text">
                ...
                <div className="col-lg-4 col-md-6 mb-30">
                  <div className="services-item paste2-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/7.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/7.png" alt="" />
                      </div>
                    </div>
                    <div className="services-content">
                      <div className="services-text">
                ...
                <div className="col-lg-4 col-md-6 md-mb-30">
                  <div className="services-item purple2-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/8.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/8.png" alt="" />
                      </div>
                    </div>
                    <div className="services-content">
                      <div className="services-text">
                ...
                <div className="col-lg-4 col-md-6 sm-mb-30">
                  <div className="services-item cyan2-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/9.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/9.png" alt="" />
                      </div>
                    </div>
                    <div className="services-content">
                      <div className="services-text">
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="services-item pink2-bg">
                    <div className="services-icon">
                      <div className="image-part">
                        <img className="main-img" src="assets/images/services/style3/main-img/10.png" alt="" />
                        <img className="hover-img" src="assets/images/services/style3/hover-img/10.png" alt="" />
                      </div>
                    </div>
                    <div className="services-content">
                      <div className="services-text">
              ...
              <div className="row">
                <div className="col-lg-2 col-md-4 col-sm-4 col-6">
                  <div className="technology-item">
                    <a href="#">
                      <div className="logo-img">
                        <img src="assets/images/technology/style2/1.png" alt="" />
                      </div>
                    </a>
                  </div>
                </div>
